...
const SideBar = () => {
  ...
  return (
    <div className={`lg:w-[30%] w-full h-full bg-slate-100 border-r border-slate-200 ${selectedUser ? "hidden lg:flex" : "flex"} flex-col lg:flex`}>
      {/* Header */}
      <div className="w-full h-[80px] bg-blue-400 flex items-center justify-between px-6 shadow-sm">
        ...
        <div className="text-white flex gap-2 items-center" onClick={() => navigate("/profile") }>
          <img
